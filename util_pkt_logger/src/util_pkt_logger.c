...
void open_log(void) {
    ...
    i = fprintf(log_file,"\"UTC timestamp\",\"us count\",\"frequency\",\"RF chain\",\"RX chain\",\"size\",\"modulation\",\"bandwidth\",\"datarate\",\"coderate\",\"RSSI\",\"SNR\",\"payload\"\n");
    if (i < 0) {
...
/******************************************begin MQTT section******************************************/
                ...
                if(!samePayload){
                    printf("MQTT message, chanel %d, %s,%s \n", p->if_chain,timebuf,mqtt_message);
